"""
L3 数据描述性报告脚本
输出：data/processed/describe_level4_report.txt
"""
import pandas as pd
import numpy as np
from pathlib import Path

DF = Path("data/processed/leadership_feedback_level4_wide.csv")
OUT = Path("data/processed/describe_level4_report.txt")
