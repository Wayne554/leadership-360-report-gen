...
ABOVE_EXPLAIN = {
    "战略思维-科学决策": ["您对战略层面的思考深度与前瞻性，或许还未完全被上级看到——毕竟上级掌握的信息和全局视角与您不尽相同，这在一定程度上拉大了双方认知的距离。不过，这也提示您与上级就战略方向进行更系统的沟通，或许是一个值得投入的发力点。同时，也值得关注战略规划与资源配置之间的衔接，确保长短期目标之间的平衡更加清晰。"],
    "创新引领-持续精进": ["在探索新方法和推动改进方面，上级或许期望看到更积极的动作或更显著的效果——您付出的努力可能还没有以充分可感知的方式呈现在上级视野中，同时日常执行的负荷也许占据了较多精力，导致在创新上的投入未能完全满足上级的期望。试着在推进日常工作的同时，也为创新项目留出一些可见的时间窗口，让您的探索精神更容易被看见。"],
    "全球视野-管理复杂情况": ["在应对复杂局面时，上级或许期望您展现出更开阔的视野或更长远的判断——您的决策能力可能已经超出了自己的预期，但在上级眼中，或许还有进一步展现的空间。尤其在跨领域或不确定性环境下的表现，或许是您展示全球视野的好机会，试着在模糊情境中主动分享您的思考过程，让他人更清晰地看到您把握方向的能力。"],
    "客户导向-珍视客户": ["在客户需求的深度理解与前瞻响应方面，上级或许期望看到更持续的表现——客户导向不仅体现在即时响应，更在于对客户潜在需求的系统性洞察。同时，将客户洞察转化为产品和服务改进，或许还需要更有力的推动，这也是您进一步彰显客户价值导向的关键一步。"],
    "数智变革-加强数字应用": ["在推动数字化工具落地和数据驱动决策方面，上级或许期望看到更主动的作为——您对数字化的热情和理解深度，或许还需要更系统地在工作中得以呈现。同时，也值得审视数字化转型的具体应用场景，确保您与上级在这个维度上的期望对齐更加同频。"],
    "发展组织-带兵打仗": ["在团队建设和人才梯队培养方面，上级或许期望看到更明确的规划或更显著的成果——您在日常管理上的投入是可见的，但或许还需要以更系统的方式呈现人才发展的整体蓝图。同时，在授权的深度与广度上，上级可能认为还可以更加放手，这一步从「自己干」向「带别人干」的转变，正是组织发展中最值得关注的一环。"],
    "追求卓越-高效执行": ["在任务推进的输出质量和过程管理方面，上级或许对您有更高的期待——您的执行力有目共睹，但或许还需要在关键节点的呈现上更加清晰、更有节奏感。试着在里程碑节点上主动亮出阶段成果，让您的执行效率被更充分地感知到。"],
}
BELOW_EXPLAIN = {
    "战略思维-科学决策": ["在战略思考和决策方面，上级对您的评价比您自己更为积极——这说明您在战略层面的判断力和贡献，对上级而言是可见且值得肯定的。同时，您对自身在战略维度的要求，或许比别人的感知更为严格，这份自我苛求的品质，也正是您持续进步的内在动力。"],
    "创新引领-持续精进": ["您推动创新与改进的努力，对上级而言或许比您自己意识到的更为可见——这说明您在探索新方法上的投入，已经被上级看在眼里。同时，您在日常工作中展现的探索精神，或许也被自己低估了，这份敢于尝试的行动力，正是持续精进最宝贵的起点。"],
    "全球视野-管理复杂情况": ["在应对复杂局面方面，上级对您的认可比您自己更为积极——这说明您在不确定性环境中的沉稳判断与协调能力，对上级而言是清晰可见的优势。同时，您在跨领域协调中的表现，或许给上级留下了比您自己以为更深的印象，这份在模糊中把握方向的能力，正是管理复杂情况的核心素养。"],
    "客户导向-珍视客户": ["在客户价值方面的投入和成效，上级对您的评价比您自己更为积极——这说明您在客户需求的理解与响应上已经展现出了突出的能力。同时，您对自身在客户维度的判断或许比别人更为严格，这份对客户体验的敏锐度和责任感，正是珍视客户最宝贵的基石。"],
    "数智变革-加强数字应用": ["在数字化推动方面，上级对您的努力有比您自己更为积极的认可——这说明您在数字化工具落地和数据驱动决策上的尝试，已经有了可见的成效。同时，您在这方面的投入和成果，或许在自我评估中被低估了，这份在变革中主动前行的勇气，正是推动数智转型最宝贵的力量。"],
    "发展组织-带兵打仗": ["在团队培养与人才发展方面，上级对您的评价比您自己更为积极——这说明您在带团队上的投入与成效，对上级而言是值得肯定的。同时，您在团队管理方面展现的能力，或许比您自己认为的更为成熟，这份自信的建立，也是您未来带领更大团队的重要基石。"],
    "追求卓越-高效执行": ["在任务推进与结果交付方面，上级对您的表现比您自己认为的更为信赖——这说明您的执行质量和效率已经超出了自己的认知范围，对上级而言是可靠的保障。同时，也值得您更加自信地看待自己在执行力上的优势，这份「凡事有交代」的靠谱品质，正是追求卓越最扎实的底色。"],
}
